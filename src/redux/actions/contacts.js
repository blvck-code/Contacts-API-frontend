...
import { CONTACTS_LOAD_ERROR, CONTACTS_LOADING, CONTACTS_LOAD_SUCCESS, ADD_CONTACT_LOAD, ADD_CONTACT_SUCCESS, ADD_CONTACT_ERROR } from '../../constants/types';
...
export const createContact = ({
    ...
    const body = {first_name, last_name, country_code, phone_number, contact_pic}
